function [position, moment] = visualize_phase_space_connectivity_leida_abs_speed(leading_eigen, centroid,video,interactive,toplot)
...
moment = reconf_speeds;

position = abs((centroid)*(leading_eigen));
